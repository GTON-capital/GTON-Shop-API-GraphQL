...
func (p *Proxy) UploadTokenData(metadata types.JsonMetadata, image types.Image) (uri string, err error) {
	...
	imageUri := "https://moccasin-secondary-hippopotamus-761.mypinata.cloud/ipfs/" + cid
	...
	return "https://moccasin-secondary-hippopotamus-761.mypinata.cloud/ipfs/" + cid, nil
}
